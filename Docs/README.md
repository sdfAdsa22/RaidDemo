...
| [Decisions/](Decisions/) | 架构决策记录（ADR），记录关键技术取舍 | 已收录 3 篇 |
| [Assets/素材候选清单.md](Assets/素材候选清单.md) | 美术/音效素材来源调研与许可证核实（候选，待负责人确认） | 调研中 |
| [11_M0问题记录与排障手册.md](11_M0问题记录与排障手册.md) | M0 阶段的工具链/构建/网络/环境问题记录与解决方案 | 已收录 6 条 |
| `Modules/` | 各系统的详细设计文档（背包/战斗/AI/战局/局外），进入对应里程碑时创建 | 未开始 |
