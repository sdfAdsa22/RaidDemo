...
namespace RaidDemo.Bootstrap.Editor
{
    ...
    public static partial class ItemContentBuilder
    {
        ...
        private static readonly ItemSpec[] s_Specs =
        {
            ...
            new ItemSpec("ammo.12ga.buck", "12 号霰弹", ItemCategory.Ammo, RarityTier.Common,
                1, 1, 0.045f, 20, 30, canRotate: false,
                description: "12 号霰弹，一发装六颗弹丸。近距离威力最大，对护甲却很吃力。"),
            ...
            new ItemSpec("weapon.smg.uzi", "UZI 冲锋枪", ItemCategory.Weapon, RarityTier.Uncommon,
                2, 1, 2.2f, 9000, 1, canRotate: true,
                description: "紧凑冲锋枪，全自动 900 发/分，10 米内像泼水一样压制。"),
            new ItemSpec("weapon.shotgun.pump", "泵动霰弹枪", ItemCategory.Weapon, RarityTier.Rare,
                3, 1, 3.4f, 11000, 1, canRotate: true,
                description: "泵动霰弹枪，一发六颗弹丸，6 米内一枪撂倒；打一发要拉一下护木。"),
            ...
            new ItemSpec("armor.helmet.heavy", "重型头盔", ItemCategory.Helmet, RarityTier.Epic,
                2, 2, 2.0f, 28000, 1, canRotate: false,
                description: "四级重型头盔，用配重换来头部的最高防护——戴上它你会更想早点撤离。"),
            new ItemSpec("armor.vest.heavy", "重型防弹衣", ItemCategory.BodyArmor, RarityTier.Epic,
                2, 3, 8.0f, 45000, 1, canRotate: true,
                description: "四级重型背心，正面能挡下标准步枪弹；8 公斤的重量会明显拖慢脚步。"),
